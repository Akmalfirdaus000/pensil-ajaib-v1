...
{
	global $db;
	$get_product = "SELECT * FROM products ORDER BY 1 DESC LIMIT 6"; // Mengambil 6 produk terbaru
...
function getPcatPro()
{
    ...
    <div class='prod'>
        ...
        <p class='buttons'>
            ...
            <a href='details.php?pro_id=$pro_id' class='btn btn-primary'> <i class='fa fa-shopping-cart'>Add to cart</i>
            </a>
        </p>
