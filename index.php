...
<div class="col-md-6 offer">
    ...
    <br><br>
<a id="pr" href="#"> Total Harga: Rp : <?php totalPrice(); ?>, Total Orderan Yang Diambil
: <?php item(); ?></a>
</div>
...
<nav class="navbar"> 
     ...
     <ul >
        <li>
            ...
            <li><a class="active" href="index.php">Awal</a></li>
             
            <li><a href="trimer.php">Semua Orderan</a></li>
            <li><a href="#arrival">Desain</a></li>
            <li><a href="#parlor">Website</a></li>
            <li><a href="contactus.php">Kontak</a></li>
            <li><a href="#footer">Tentang Kita</a></li>
